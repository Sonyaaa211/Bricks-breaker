                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (_selectedType == -1 && selectedNode == i)
                    {
                        using (var scope = ChangeCheckScope.New(path))
                        {
                            ...
                            if (selectedTool == 0) { var fmh_97_88_638393568084222816 = Quaternion.identity; back = Handles.FreeMoveHandle(back, capSize * 2, snap, Handles.RectangleHandleCap); }
                    ...
                    if (_selectedType == 1 && selectedNode == i)
                    {
                        ...
                        {
                            Handles.color = capSelectedColor;
                            if (selectedTool == 0) { var fmh_121_94_638393568084243194 = Quaternion.identity; forward = Handles.FreeMoveHandle(forward, capSize * 2, snap, Handles.RectangleHandleCap); }
                    ...
                    if (_selectedType == 0 && selectedNode == i)
                    {
                        ...
                        {
                            Handles.color = capSelectedColor;
                            if (selectedTool == 0) { var fmh_144_92_638393568084246494 = Quaternion.identity; middle = Handles.FreeMoveHandle(middle, capSize * 2, snap, Handles.RectangleHandleCap); }
